...
class Surrogate_Accelerator_v1(gym.Env):
  def __init__(self):
    ...
    self.booster_model = keras.models.load_model('../surrogate_models/fullbooster_noshift_e250_bs99_nsteps250k_invar5_outvar3_axis1_mmscaler_t0_D10122020-T175237_kfold2__e16_vl0.00038.h5')
  ...
  def render(self):
    ...
    for v in range(0,nvars):
      ...
      if v==0:
        ...
        axs[v].set_title('Raw data reward: {:.2f} - RL agent reward: {:.2f} '.format(self.data_total_reward,self.total_reward))
